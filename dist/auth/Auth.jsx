                                ...
                                <section role="main" className={styles._qj62pw} >
                                    ...
                                    <div>
                                        ...
                                        <form id="form-login" data-testid="form-login" className={styles._r44k6v} >
                                                ...
                                                <div className={styles._cnfgt3} >
                                                    <div className={styles._q5x77e} >
                                                        <div role="presentation" data-ds--text-field--container="true" data-testid="username-container" className={styles._1s25hsw} >
                                                            <input aria-describedby="username-uid2-helper" aria-labelledby="username-uid2-label" id="username" autoComplete="username" type="email" data-ds--text-field--input="true" data-testid="username" name="username" placeholder="Введите адрес электронной почты" className={styles._1cab8vv} readOnly="" wfd-id="id0" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className={styles._cnfgt3} >
                                                        ...
                                                        <div className={styles._1xfynbg} >
                                                            <div className={styles._q5x77e} >
                                                                <div role="presentation" data-ds--text-field--container="true" data-testid="password-container" className={styles._1s25hsw} >
                                                                    <input aria-describedby="password-uid3-helper" aria-labelledby="password-uid3-label" id="password" autoComplete="current-password" type="password" spellCheck="false" data-ds--text-field--input="true" data-testid="password" name="password" placeholder="Введите пароль" className={styles._1cab8vv} readOnly="" wfd-id="id1" />
                                            ...
                                            <button id="login-submit" className={`${styles._1w9zxjf} ${styles._1edgkow}`} tabIndex="0" type="submit">
                                                <span className={styles._178ag6o} >Продолжить</span>
                                            </button>
