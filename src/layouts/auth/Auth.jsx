...
export default function Auth(props){
  return (
    <div>
        ...
        <div id="root">
            <div className="css-4b375e" >
                <div className="css-q0b2qn">
                    <div className="css-xxwux">
                        <div className="css-tw4vmx"></div>
                        <div className="css-auqgo3">
                            {/* <div className="css-d69kqk"> */}
                            <div className="css-11jwunr">
                                <div id="WhiteboxContainer" className="css-1iefl20">
                                    <section role="main" className="css-qj62pw">
                                        <div data-testid="header" id="ProductHeading" className="css-146wmq">
                                            <span aria-label="Trello" role="img" className="css-a3l9jr" >
                                                <svg viewBox="0 0 190 32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                                                    <defs>
                                        ...
                                        <div data-testid="header-suffix" id="ProductHeadingSuffix" className="css-azin1o">
                                            <h5>Войдите, чтобы продолжить</h5>
                                        </div>
                                        </div>
                                        <div>
                                            <span></span>
                                            <form id="form-login" data-testid="form-login" className="css-r44k6v">
                                                <div className="css-env1z2">
                                                    <div className="  css-cnfgt3">
                                                        <div className="css-q5x77e">
                                                            <div role="presentation" data-ds--text-field--container="true" data-testid="username-container" className="css-1s25hsw">
                                                                <input aria-describedby="username-uid2-helper" aria-labelledby="username-uid2-label" id="username" autoComplete="username" type="email" data-ds--text-field--input="true" data-testid="username" name="username" placeholder="Введите адрес электронной почты" className="css-1cab8vv" readOnly="" wfd-id="id0" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="field-group password-field css-cnfgt3">
                                                        <div>
                                                            <div className="css-1xfynbg">
                                                                <div className="css-q5x77e">
                                                                    <div role="presentation" data-ds--text-field--container="true" data-testid="password-container" className="css-1s25hsw">
                                                                        <input aria-describedby="password-uid3-helper" aria-labelledby="password-uid3-label" id="password" autoComplete="current-password" type="password" spellCheck="false" data-ds--text-field--input="true" data-testid="password" name="password" placeholder="Введите пароль" className="css-1cab8vv" readOnly="" wfd-id="id1" />
                                                                        <div className="css-lspp5b">
                                                                            <button type="button" className="css-o6ruxu">
                                                                                <span className="css-1spmf3f">
                                                                                    ...
                                                                                    <span className="css-b5o75w">Show password</span>
                                                                                </span>
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <button id="login-submit" className="css-1w9zxjf css-1edgkow" tabIndex="0" type="submit">
                                                    <span className="css-178ag6o">Продолжить</span>
                                                </button>
                                                <div className=" hidden css-cnfgt3">
                                                    <button id="passwordless-button" className="css-8x8i7r css-q2jxx8" tabIndex="0" type="button">
                                                        <span className="css-1ti50tg">
                                                            <span role="img" aria-label="email" className="css-snhnyn" >
                                                                <svg width="24" height="24" viewBox="0 0 24 24" role="presentation">
                                                                    <g fill="currentColor" fillRule="evenodd">
                                                        ...
                                                        <span className="css-178ag6o">Войти с помощью электронной почты</span>
                                                        <span className="css-1yrfxm9">
                                        ...
                                        <div data-i18n-or="или" data-i18n-continue="Или продолжить с помощью:" className="google-login social-login css-1n7nx3r" data-testid="social-login-wrapper">
                                            <div data-testid="social-login-button-row" className="css-1vymulm">
                                                <div className="css-1vymulm">
                                                    <button id="google-auth-button" className="css-8x8i7r css-q2jxx8" tabIndex="0" type="button">
                                                        <span className="css-1ti50tg">
                                                            {/* <img src="assets/svg/google-logo.5867462c.svg" alt="logo" /> */}
                                                            <Icons name={'google-logo'} sizeWidth={"18px"} sizeHeight={"18px"} />
                                                        </span>
                                                        <span className="css-178ag6o">Google</span>
                                                    </button>
                                                </div>
                                                <div className="css-1vymulm">
                                                    <button id="microsoft-auth-button" className="css-8x8i7r css-q2jxx8" tabIndex="0" type="button">
                                                        <span className="css-1ti50tg">
                                                            {/* <img src="assets/svg/microsoft-logo.c73d8dca.svg" alt="logo" /> */}
                                                            <Icons name={'microsoft-logo'} sizeWidth={"21px"} sizeHeight={"21px"} />
                                                        </span>
                                                        <span className="css-178ag6o">Microsoft</span>
                                                    </button>
                                                </div>
                                            </div>
                                            <div data-testid="social-login-button-row" className="css-1vymulm">
                                                <div className="css-1vymulm">
                                                    <button id="apple-auth-button" className="css-8x8i7r css-q2jxx8" tabIndex="0" type="button">
                                                        <span className="css-1ti50tg">
                                                            {/* <img src="assets/svg/apple-logo.54e0d711.svg" alt="logo" /> */}
                                                            <Icons name={'apple-logo'} sizeWidth={"18px"} sizeHeight={"18px"} />
                                                        </span>
                                                        <span className="css-178ag6o">Apple</span>
                                                    </button>
                                                </div>
                                                <div className="css-1vymulm">
                                                    <button id="slack-auth-button" className="css-8x8i7r css-q2jxx8" tabIndex="0" type="button">
                                                        <span className="css-1ti50tg">
                                                            {/* <img src="assets/svg/slack-logo.5d730c10.svg" alt="logo" /> */}
                                                            <Icons name={'slack-logo'} sizeWidth={"18px"} sizeHeight={"18px"} />
                                                        </span>
                                                        <span className="css-178ag6o">Slack</span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="css-1vt5tf0">
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    <a id="signup" className="primary-action" href="/signup?prompt=none&amp;login_hint=kildushev%40gmail.com&amp;continue=https%3A%2F%2Fid.atlassian.com%2Fmanage-profile&amp;application=trello">
                                                        Создать аккаунт
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="css-pj36kz"></div>
                                        <div className="css-1ef928d">
                                            <footer data-testid="page-footer" className="css-1tn479n">
                                                <span aria-label="Atlassian" role="img" className="css-1eu9lrx" >
                                                ...
                                                <div className="css-ftz4sr">Один аккаунт для Trello, Jira, Confluence и 
                                                    <a id="atlassian-account-link-more-short" target="_blank" rel="noreferrer noopener" aria-label="Learn more about Atlassian Account" href="https://support.atlassian.com/atlassian-account/docs/what-is-an-atlassian-account/" className="css-1gc25jr">
                                                        не только
                                                    </a>.
                                                </div>
                                            </footer>
                                            <ul className="fine-print">
                                                <li>
                                                    <a href="https://www.atlassian.com/legal/privacy-policy" target="_blank" rel="noreferrer noopener" className="css-1gc25jr">
                                                        Политика конфиденциальности
                                                    </a>
                                                </li>
                                                <p className="css-1x34ed1">•</p>
                                                <li>
                                                    <a href="https://www.atlassian.com/legal/user-notice" target="_blank" rel="noreferrer noopener" className="css-1gc25jr">
                                                        Уведомление пользователя
                                                    </a>
                                                </li>
                                            </ul>
                                            <div className="css-1s4vgyd">Для защиты сайта используется система reCAPTCHA. Кроме того, действуют положения 
                                                <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer noopener" className="css-1y8hiba">
                                                    Политики конфиденциальности
                                                </a> и 
                                                <a href="https://policies.google.com/terms" target="_blank" rel="noreferrer noopener" className="css-1y8hiba">
